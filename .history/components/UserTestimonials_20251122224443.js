  ...
  return (
    ...
    >
      <div className="container mx-auto p-4 px-5 md:px-[5%] 2xl:px-0 max-w-[1200px]">
        <div className="text-center mb-12 bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 shadow-2xl">
          <motion.h2
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-2xl shadow-xl hover:bg-white/15 hover:border-purple-400/40 hover:shadow-2xl transition-all duration-300 hover:scale-[1.02]"
            >
              ...
              <blockquote className="text-white/90 mb-6 italic font-medium leading-relaxed">
                &quot;{testimonial.text}&quot;
              </blockquote>
