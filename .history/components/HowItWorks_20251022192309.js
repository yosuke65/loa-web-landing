            ...
            >
              <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-6 border">
                <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl p-6 text-white text-center mb-6">
                  ...
                  <h4 className="font-bold text-lg mb-2">Manifestation Moment</h4>
                  <p className="text-purple-100 text-sm">"I attract opportunities that align with my highest good"</p>
                </div>
                ...
                <div className="flex gap-2 justify-center">
                  <button className="bg-gray-200 text-gray-700 px-4 py-2 rounded-full text-sm">Continue</button>
                  <button className="bg-purple-600 text-white px-4 py-2 rounded-full text-sm">Manifest</button>
                </div>
              </div>
            </motion.article>
          </div>
