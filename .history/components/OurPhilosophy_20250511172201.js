          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-10">
            <article className="flex flex-col justify-center">
              ...
              <motion.p
                ...
                className="mt-8"
              >
                "We believe your digital moments — the songs you listen to, the
                thoughts you write, the photos you take, and even the posts you
                share — all hold meaning. Our mission is to help you reflect,
                preserve, and piece together the life story only you could live.
              </motion.p>
            </article>
            <Image
