    ...
    >
      <div className="container mx-auto p-4 px-5 md:px-[5%] 2xl:px-0 max-w-[1200px]">
        <div className="text-center mb-12">
          ...
          >
            Join thousands of manifestors who are using LoA to align their digital habits 
            with their highest intentions and attract more of what they truly desire.
          </motion.p>
        </div>
        ...
        >
          <div className="bg-gradient-to-r from-indigo-900 via-purple-900 to-black text-white p-8 rounded-lg">
            ...
            <p className="text-purple-100 mb-6 max-w-2xl mx-auto">
              Begin your journey of digital consciousness today. Transform every phone 
              interaction into a moment of manifestation and energetic alignment with 
              your highest self.
            </p>
