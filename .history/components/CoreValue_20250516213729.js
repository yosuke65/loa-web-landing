...
const values = [
  {
    ...
    desc: `You don’t need to perform or overthink — you just need to show up. Whether it begins with a feeling, a photo, or a quiet moment, Ever Journal meets you where you are and helps you reflect with ease.<br /><span class="italic text-black/60">💡 Your story starts with your truth — not perfection.</span>`,
  },
  {
    id: "02",
    title: "Your Private Life Matters Most",
    desc: `You shouldn’t need an audience to validate your memories. We help you gather the moments that shaped you — even the ones no one else saw — and organize them into something personally meaningful.<br /><span class="italic text-black/60">💡 You don’t share for likes. You reflect for clarity.</span>`,
  },
  {
    id: "03",
    title: "Your Story Builds Over Time",
    desc: `You don’t need to plan your legacy. You just need to write your next entry. With every journal, Ever Journal begins to assemble your biography — quietly, beautifully, and in the background.<br /><span class="italic text-black/60">💡 Let your life tell the story, one reflection at a time.</span>`,
  },
  {
    id: "04",
    title: "Privacy Is the Default. Sharing Is a Choice.",
    desc: `Your entries are fully yours — secure, private, and never shared unless you say so. And when you’re ready, you can choose to share a chapter with someone you trust — or save it for your future self.<br /><span class="italic text-black/60">💡 Your story isn’t content. It’s a gift — and you decide who receives it.</span>`,
  },
  {
    id: "05",
    title: "A Culture of Reflection, Not Just Recording",
    desc: `We’re not building another feed. We’re building a home for memory. Ever Journal invites people to slow down, reflect more often, and grow through self-awareness — not performance.<br /><span class="italic text-black/60">💡 Because your life deserves more than likes — it deserves meaning.</span>`,
  },
];
