        ...
        <div className="overflow-x-auto mt-16">
          <div className="lg:hidden">
            {featuresData.map((featureItem, index) => (
              <div
                key={index}
                className="mb-6 p-4 rounded-lg shadow-md bg-secondary text-primary"
              >
                  ...
                  <tbody>
                    ...
                    <tr className="bg-white border-b border-gray-700">
                      ...
                      <td className="py-2 px-3 flex gap-2 items-center">
                        ...
                        {featureItem.dayOne === "Yes"
                          ? "Yes"
                          : featureItem.dayOne === "No"
                          ? "No"
                          : "Partial"}
                      </td>
                    </tr>
                    <tr className="bg-white border-b border-gray-700">
                      ...
                      <td className="py-2 px-3 flex gap-2 items-center">
                        ...
                        {featureItem.notion === "Yes"
                          ? "Yes"
                          : featureItem.notion === "No"
                          ? "No"
                          : "Partial"}
                      </td>
                    </tr>
                    <tr className="bg-white border-b border-gray-700">
                      ...
                      <td className="py-2 px-3 flex gap-2 items-center">
                        ...
                        {featureItem.chatGPT === "Yes"
                          ? "Yes"
                          : featureItem.chatGPT === "No"
                          ? "No"
                          : "Partial"}
                      </td>
                    </tr>
                    <tr className="bg-white">
                      ...
                      <td className="py-2 px-3 flex gap-2 items-center">
                        {featureItem.memoirServices === "Yes" && (
                          <GiCheckMark />
                        )}
                        {featureItem.memoirServices === "No" && <MdClose />}
                        {featureItem.memoirServices === "Partial" && (
                          <CgDanger />
                        )}
                        {featureItem.memoirServices === "Yes"
                          ? "Yes"
                          : featureItem.memoirServices === "No"
                          ? "No"
                          : "Partial"}
                      </td>
                    </tr>
            ...
            <table className="w-full rounded-lg text-sm text-left">
              ...
              <tbody>
                {featuresData.map((featureItem, index) => (
                  <tr
                    key={index}
                    className="bg-white text-primary border-b border-gray-700"
                  >
                    <th
                      scope="row"
                      className="py-4 p-5 font-medium text-left text-primary whitespace-nowrap"
                    >
                      {featureItem.feature}
                    </th>
                    <td className="py-5 px-3">
                      {featureItem.everJournal === "Yes" && (
                        <GiCheckMark className="inline pr-1 w-5 h-5" />
                      )}
                      {featureItem.everJournal === "No" && (
                        <MdClose className="inline pr-1 w-5 h-5" />
                      )}
                      {featureItem.everJournal === "Yes" ? "Yes" : "No"}
                    </td>
                    <td className="py-5 px-3">
                      ...
                      {featureItem.dayOne === "Partial" && (
                        <CgDanger className="inline pr-1 w-5 h-5" />
                      )}
                      {featureItem.dayOne === "Yes"
                        ? "Yes"
                        : featureItem.dayOne === "No"
