...
const values = [
  {
    ...
    desc: "You don’t need to perform or overthink — you just need to show up.

Whether it begins with a feeling, a photo, or a quiet moment, Ever Journal meets you where you are and helps you reflect with ease.
