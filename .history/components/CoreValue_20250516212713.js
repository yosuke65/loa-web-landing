...
const values = [
  ...
  },
  {
    ...
    desc: "You shouldn’t need an audience to validate your memories. We help you gather the moments that shaped you — even the ones no one else saw — and organize them into something personally meaningful.

💡 *You don’t share for likes. You reflect for clarity.*",
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <article className="flex flex-col items-center justify-center mt-16">
            <p className="mt-5 text-justify md:max-w-[60%] md:text-center">
              At <strong>LoA</strong>, we believe your life isn’t meant
