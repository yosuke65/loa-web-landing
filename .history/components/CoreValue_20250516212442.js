...
const values = [
  {
    ...
    desc: "You don’t need the perfect words to start journaling — you just need a moment. Whether it begins with a thought, a song, or a photo, Ever Journal helps you reflect in ways that feel natural and intuitive.\n\n💡 Start from anywhere. Everything meaningful begins somewhere.",
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <article className="flex flex-col items-center justify-center mt-16">
            <p className="mt-5 text-justify md:max-w-[60%] md:text-center">
              At **Ever Journal**, we believe your life isn’t meant to be
              curated for others — it’s meant to be understood by <strong></strong>you. Our
              values reflect our commitment to helping you **slow down, reflect
              deeply, and preserve what truly matters**, one journal at a time.
            </p>
          </article>
        </div>
