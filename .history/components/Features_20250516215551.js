...
const features = [
  {
    ...
    desc: [
      "No blank pages. No pressure. Just thoughtful prompts and mood-aware guidance from Eve, your AI companion.",
      "Write, speak, or tap how you feel — your reflections stay grounded and authentic.",
      "Every entry becomes part of your evolving story, captured on your terms.",
    ],
  },
  {
    id: "02",
    ...
    desc: [
      "Collect your thoughts, emotions, photos, and memories in a private-first timeline.",
      "No feeds, no noise — just the moments that mattered to you.",
      "Ever Journal becomes the quiet center of your personal story.",
    ],
  },
  {
    id: "03",
