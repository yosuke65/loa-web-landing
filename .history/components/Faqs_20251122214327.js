  ...
  return (
    ...
    >
      <article className="container mx-auto py-14 p-4 px-5 md:px-[5%] 2xl:px-0 max-w-5xl flex flex-col items-center justify-center gap-4">
        <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 shadow-2xl w-full">
        ...
        <ul className="space-y-4 mt-14 w-full">
          {faqs.map((faq, index) => (
            ...
            >
              <div
                className={`faq-item border-b-2 bg-white/10 backdrop-blur-md border-white/20 rounded-xl p-4 shadow-lg ${
                  activeIndex === index
                    ? "py-6 px-4 bg-white/20 text-gray-900"
                    : ""
                }`}
              >
