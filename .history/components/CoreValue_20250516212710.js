...
const values = [
  ...
  },
  {
    ...
    desc: "You shouldn’t need an audience to validate your memories.

We help you gather the moments that shaped you — even the ones no one else saw — and organize them into something personally meaningful.
