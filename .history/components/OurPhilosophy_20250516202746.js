          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-10">
            <article className="flex flex-col justify-center">
              ...
              >
                ...
                is built to understand your whole self. Not built for
                followers — built for your future self.” **Bring together your
                thoughts, photos, and memories — and reflect on your life in one
                private, meaningful space.** *Not built for followers — built
