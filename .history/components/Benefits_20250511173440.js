...
const features = [
  ...
  },
  {
    ...
    desc: "Sync your digital life — from Spotify and Instagram to Google Photos and YouTube.
All your content flows into one private space where your memories and media come together.",
  },
  {
    id: "03",
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <article className="flex flex-col items-center justify-center mt-16">
            ...
            <p className="mt-5 text-justify md:max-w-[60%] md:text-center">
              ...
              reflecting meaningfully. LoA helps you capture your
