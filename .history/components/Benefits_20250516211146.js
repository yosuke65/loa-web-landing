      ...
      <article className="container mx-auto py-14 p-4 px-5 md:px-[5%] 2xl:px-0 max-w-[1200px] gap-4flex flex-col items-center justify-center gap-4">
        <div className="flex flex-col items-center justify-center">
          ...
          <article className="flex flex-col items-center justify-center mt-16">
            ...
            We believe your thoughts, emotions, and everyday moments deserve more than a scroll and a like.

Ever Journal is your private space to make sense of your life — not for followers, but for your future self
            </p>
          </article>
        </div>
