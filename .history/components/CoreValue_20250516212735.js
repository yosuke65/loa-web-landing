...
const values = [
  ...
  },
  {
    ...
    desc: "You don’t need to plan your legacy. You just need to write your next entry.

With every journal, Ever Journal begins to assemble your biography — quietly, beautifully, and in the background.
