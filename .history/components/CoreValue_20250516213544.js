...
const values = [
  {
    ...
    desc: `You don’t need to perform or overthink — you just need to show up. Whether it begins with a feeling, a photo, or a quiet moment, LoA meets you where you are and helps you reflect with ease.<br /><span class="italic text-secondary/80">💡 Your story starts with your truth — not perfection.</span>`,
  },
  {
    id: "02",
  ...
  },
  {
    ...
    desc: `You don’t need to plan your legacy. You just need to write your next entry. With every journal, LoA begins to assemble your biography — quietly, beautifully, and in the background.<br /><span class="italic text-secondary/80">💡 Let your life tell the story, one reflection at a time.</span>`,
  },
  {
    id: "04",
  ...
  },
  {
    ...
    desc: `We’re not building another feed. We’re building a home for memory. LoA invites people to slow down, reflect more often, and grow through self-awareness — not performance.<br /><span class="italic text-secondary/80">💡 Because your life deserves more than likes — it deserves meaning.</span>`,
  },
];
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {values.map((item) => (
            ...
            >
              ...
              <p
                className="text-base text-center lg:text-left text-/90"
