        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <article className="flex flex-col items-center justify-center mt-16">
            <p className="mt-5 text-justify md:max-w-[60%] md:text-center">
              ...
              others — it’s meant to be understood by you*. Our values reflect
              our commitment to helping you **slow down, reflect deeply, and
              preserve what truly matters**, one journal at a time.
            </p>
          </article>
        </div>
