      ...
      <tbody className="text-white">
        {featuresData.map((featureItem, index) => (
          ...
          >
            ...
            <td className="py-4 px-3 text-center">{featureItem.everJournal}</td>
            <td className="py-4 px-3 text-center">{featureItem.dayOne}</td>
            <td className="py-4 px-3 text-center">{featureItem.notion}</td>
            <td className="py-4 px-3 text-center">{featureItem.chatGPT}</td>
            <td className="py-4 px-3 text-center">{featureItem.memoirServices}</td>
          </tr>
        ))}
      </tbody>
    </table>
