...
export const privacyPolicy = [
  {
    ...
    subtext2: "To improve the app's performance and user experience, we may collect limited, anonymized data such as:",
    list: [
    ...
    addition: "This data does not contain any personal identifiers (such as name, email, or precise location).",
    subtext3: "b. Permissions",
    subtext4: "Loa may request permission to detect when certain apps are opened — only to display mindful prompts before launching them. We do not read or track your app content, messages, or browsing history.",
    subtext5: "c. Optional Cloud Sync (if enabled)",
    subtext6: "If future updates allow syncing affirmations or user preferences via cloud backup, we may temporarily store this data under your account. You will be clearly informed and able to opt out at any time."
  },
  {
    id: uuid(),
    ...
    addition: "We never sell, rent, or share your data with third parties for advertising or marketing purposes."
  },
  {
    id: uuid(),
    ...
    addition: "Each third party adheres to GDPR and CCPA-compliant standards. You can review their policies here:",
    sublist: [
  ...
  },
  {
    ...
    text: "We only retain anonymous diagnostic data as long as needed to improve the app. If you've provided any identifiable information (e.g., through optional cloud sync), you can request deletion at any time by contacting us at:",
    list: ["📧 hawk20605@gmail.com"]
  },
  {
    id: uuid(),
    title: "Security",
  ...
  },
  {
    ...
    addition: "To exercise these rights, please contact us at hawk20605@gmail.com"
  },
  {
    id: uuid(),
