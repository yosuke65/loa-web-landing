...
export const privacyPolicy = [
  {
    ...
    addition: 'The Application does not collect precise location data from your mobile device.',
  ...
  },
  {
    ...
    addition: 'These services may collect, store, and use your data in accordance with their own privacy policies.',
    subtext: 'The Service Provider may share collected information with third parties only in the following circumstances:',
    sublist: [
  ...
  },
  {
    ...
    addition: 'Opt-Out:',
    subtext: 'You can stop all data collection by uninstalling the Application using standard removal processes on your mobile device or app marketplace.',
  },
  {
    id: uuid(),
  ...
  },
  {
    ...
    subtext: 'However, no internet-based service is 100% secure, and the Service Provider cannot guarantee absolute security.',
  },
  {
    id: uuid(),
