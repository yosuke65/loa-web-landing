          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-10">
            <article className="flex flex-col justify-center">
              ...
              >
                ...
                <span className="bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">Conscious Manifestation</span>
              </motion.h3>
              <motion.p
              ...
              >
                LoA applies the Law of Attraction to your digital habits. 
                By pausing before distractions with personalized affirmations, you redirect 
                your energy toward what you truly want to attract into your life, creating 
                micro-moments of conscious awareness throughout your day.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0, transition: { duration: 0.8 } }}
