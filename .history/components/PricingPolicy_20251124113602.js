...
const plans = [
  {
    ...
    price: '$0',
    billing: 'Free',
    benefits: ['Basic Journaling', 'Limited AI Prompts', 'Story Organization']
  },
  {
    id: '02',
    title: 'Premium Tier',
    ...
    benefits: ['AI-Assisted Journaling', 'Unlimited AI-Generated Biography', 'Multimedia Integration', 'Advanced Customization', 'Social Media Integration', 'Export & Share', 'Monetize Your Story']
  },
];
        ...
        <div className="flex flex-col items-center justify-center">
          <h2 className="text-h2 lg:text-h3 font-bold text-center tracking-tight max-w-[80%]">
            ...
            <span className="relative whitespace-nowrap text-[#505050]"> 
              <svg aria-hidden="true" viewBox="0 0 418 42" className="absolute top-2/3 left-0 h-[0.58em] w-full fill-black/50 dark:fill-black/30" preserveAspectRatio="none">
          ...
          <article className="flex flex-col items-center justify-center mt-16">
            <p className="text-justify md:max-w-[60%] md:text-center">
              Compare our Basic and Premium plans to find the perfect fit for your
              journaling and biography goals. Start your free trial now.
            </p>
          </article>
        </div>
        <div className="mt-16 lg:mt-26 grid grid-cols-1 md:grid-cols-2 gap-16">
          {plans.map((paragraph) => (
            ...
            >
              ...
              <h4 className="text-h4 font-bold font-inter mt-3 lg:mt-0">{paragraph.title}</h4>
