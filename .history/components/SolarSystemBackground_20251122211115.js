...
const SolarSystemBackground = () => {
  ...
  useEffect(() => {
    console.log("First useEffect: Setting isClient to true");
    setIsClient(true);
  }, []);
  ...
  useEffect(() => {
    ...
    console.log("Solar System Background: Initializing...");
    ...
    const animate = () => {
      ...
      console.log("Animate called - Canvas dimensions:", width, "x", height);
      ...
      console.log("Canvas cleared, about to draw test rectangle");
      ...
      if (
        ...
        imagesRef.current.sun?.complete &&
    ...
    console.log("Calling animate() for first time");
    animate();
    console.log("First animate() call completed");
  ...
  if (!isClient) {
    console.log("Rendering null because isClient is false");
    return null;
  }
