      ...
      <article className="container mx-auto py-14 p-4 px-5 md:px-[5%] 2xl:px-0 max-w-[1200px] gap-4flex flex-col items-center justify-center gap-4">
        <div className="flex flex-col items-center justify-center">
          ...
          <article className="flex flex-col items-center justify-center mt-16">
            ...
            Journaling isn’t about trying to remember everything — it’s about reflecting meaningfully. Ever Journal helps you capture your thoughts, connect your digital life, and build your story effortlessly.
            </p>
          </article>
        </div>
