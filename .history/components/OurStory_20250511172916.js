...
const story = [
  ...
  "We built Ever Journal for *remembering* — privately, emotionally, and intelligently.",
  ...
  "Ever Journal was created to bring it all together — your thoughts, music, photos, posts, and emotions — into one place where your life actually makes sense.",
  ...
  "Whether you're writing to understand yourself, process your day, or capture your legacy, Ever Journal is here to make that journey personal and beautifully yours.",
...
const OurStory = () => {
  return (
    ...
    >
      <article className="container mx-auto py-10 p-4 px-5 md:px-[5%] 2xl:px-0 max-w-[1200px] lg:grid lg:grid-cols-2 items-center justify-center gap-4">
        <div className="flex flex-col items-center lg:items-start justify-center">
          <h2 className="text-h2 lg:text-h3 font-bold text-center lg:text-left max-w-[80%]">
            How We Built Ever Journal
          </h2>
