...
const Navbar = () => {
  ...
  return (
    <motion.nav
      className="fixed top-0 left-0 w-full min-h-[80px] z-50 bg-gradient-to-r from-indigo-900 via-purple-900 to-black"
    ...
    >
      <article className="p-4 px-5 md:px-[5%] w-full mx-auto flex items-center justify-between">
        ...
        >
          <Image src="/loa.svg" alt="LoA" width={30} height={30} />
          LoA
        </Link>
