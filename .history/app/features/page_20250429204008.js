    ...
    <>
      ...
      >
        <section className="w-full container px-5 md:px-[5%] 2xl:px-0 max-w-[1200px] mx-auto flex flex-col lg:flex-row-reverse items-center lg:items-start justify-center lg:gap-5 gap-8">
          ...
          >
            <Image src="/features/featuresMob.png" alt="Ever Journal Mockup" className="max-w-[100%] mt-[-80px] md:hidden" width={500} height={200} />
            <Image src="/features/features.png" alt="Ever Journal Mockup" className="w-full hidden mt-[-80px] md:block" width={200} height={400} />
          </motion.article>
        </section>
      </motion.article>
      <Feature />
