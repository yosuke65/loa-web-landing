  ...
  return (
    <>
      ...
      >
        ...
        <div className="mx-auto px-5 md:px-[5%] pb-20 container max-w-[1200px] space-y-6">
          {/* Header Card */}
          ...
          >
            ...
            <button
              type="submit"
              className="bg-gradient-to-r from-purple-500 to-pink-500 active:scale-95 hover:from-purple-600 hover:to-pink-600 transition-all text-white font-bold h-[48px] rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 focus:ring-offset-transparent shadow-lg"
            >
              Submit
            </button>
          </motion.form>
