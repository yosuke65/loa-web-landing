      ...
      >
        <section className="w-full max-w-5xl mx-auto flex flex-col items-center justify-center gap-8">
          <article className="relative w-full p-4 mx-auto flex flex-col items-center justify-center">
            ...
            >
              Bring together your thoughts, moments, and memories — and reflect on your life in one quiet, meaningful space.
              Not built to share everything with the world — built to help you understand it for yourself.
            </motion.p>
