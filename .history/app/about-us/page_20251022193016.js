      ...
      >
        <section className="w-full px-5 md:px-[5%] 2xl:px-0 max-w-5xl mx-auto flex flex-col items-center justify-center gap-8">
          <article className="relative w-full py-4 mx-auto flex flex-col items-center justify-center">
            ...
            >
              We believe technology should serve your highest good, not scatter your energy.
              LoA helps you create conscious moments between impulse and action, 
              transforming digital distractions into opportunities for manifestation and alignment.
            </motion.p>
          ...
          <motion.article
            ...
            className="flex items-center w-full justify-center p-10"
          >
            <div className="max-w-md bg-gradient-to-br from-indigo-50 to-purple-50 rounded-3xl p-8 shadow-xl border">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold bg-gradient-to-r from-indigo-900 to-purple-900 bg-clip-text text-transparent mb-4">
                  Conscious Digital Living
                </h3>
                <p className="text-gray-600 mb-6">
                  Transform every phone interaction into a moment of awareness
                  and intention.
                </p>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg shadow-sm">
                    <span className="text-sm text-gray-700">🎯 Intentions</span>
                    <span className="text-indigo-600 text-xs">Set</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg shadow-sm">
                    <span className="text-sm text-gray-700">
                      🌟 Manifestation
                    </span>
                    <span className="text-green-600 text-xs">Flowing</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <motion.article className="mt-[-100px] bg-secondary text-primary overflow-hidden">
        <article className="container mx-auto py-14 pb-32 p-4 px-5 md:px-[5%] 2xl:px-0 max-w-[1200px] flex flex-col items-center justify-center gap-12">
          ...
          <div className="text-primary text-left w-full max-w-3xl mt-8 space-y-10">
            <div>
              <h3 className="text-xl font-bold">📱 Conscious Digital Alignment</h3>
              <p>
                No judgment, just awareness. LoA tracks your digital energy patterns
                and creates gentle interruptions that help you pause and align
                with your manifestation goals before diving into potentially
            ...
            <div>
              ...
              <p>
                Transform every digital interaction into an opportunity for conscious
                growth. Our affirmation screens help you practice the Law of Attraction
                and mindfulness, turning routine app opens into moments of
                manifestation and energetic alignment.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-bold">📊 Insights Without Shame</h3>
              <p>
                Knowledge is power, but only when it's used with compassion.
                LoA provides clear insights into your digital energy patterns
                without judgment, helping you make conscious decisions about your
                digital alignment and manifestation practice.
              </p>
              <p className="mt-2 font-semibold">
                Because awareness is the first step toward conscious transformation.
              </p>
            </div>
          </div>
