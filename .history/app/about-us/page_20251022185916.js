      ...
      <motion.article className="mt-[-100px] bg-secondary text-primary overflow-hidden">
        <article className="container mx-auto py-14 pb-32 p-4 px-5 md:px-[5%] 2xl:px-0 max-w-[1200px] flex flex-col items-center justify-center gap-12">
            ...
            <h2 className="text-h2 lg:text-h3 font-bold text-center text-primary">
              Our Mission: Help People Build Intentional Relationships with Technology
            </h2>
          ...
          <div className="text-primary text-left w-full max-w-3xl mt-8 space-y-10">
            <div>
              ...
              <p>
                No judgment, just awareness. MindfulUsage tracks your app usage patterns 
                and creates gentle interruptions that help you pause and reflect before 
                diving into potentially distracting applications.
              </p>
            </div>
            <div>
              ...
              <p>
                Transform every phone interaction into an opportunity for growth. 
                Our affirmation screens help you practice manifestation and mindfulness, 
                turning routine app opens into moments of intention and self-reflection.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-bold">
              ...
              <p>
                ...
                MindfulUsage provides clear insights into your digital habits without 
                judgment, helping you make informed decisions about your technology use.
              </p>
