          ...
          <div className="mt-4 flex flex-col md:flex-row justify-between gap-14">
            <article className="flex flex-col items-center justify-center">
              <motion.p
                ...
                className="mt-2"
              >
                We believe life isn’t just about what you do, but what you feel, observe, and carry with you.

Your music, photos, thoughts, and digital moments all hold meaning — but they’re often scattered across apps and forgotten.

**Ever Journal exists to bring them together.**

It’s your journal, your memory hub, and your story — powered by AI, guided by reflection, and built entirely on your terms.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 100 }}
                whileInView={{
