      ...
      >
        <section className="w-full max-w-5xl mx-auto flex flex-col items-center justify-center gap-8">
          <article className="relative w-full p-4 mx-auto flex flex-col items-center justify-center">
            ...
            >
              Take control of your phone usage with intentional pauses. Track
              your app usage time, practice daily affirmations, and create
              mindful moments before opening apps. Turn every phone interaction
