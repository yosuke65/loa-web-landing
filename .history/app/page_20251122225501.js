        ...
        <div className="relative z-20 max-w-6xl mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            >
              ...
              <span className="bg-gradient-to-r from-purple-200 via-pink-300 to-indigo-200 bg-clip-text text-transparent font-semibold tracking-wide text-sm md:text-base whitespace-nowrap">
