...
const TypewriterHeader = ({ text }) => {
  ...
  return (
    <article className="relative flex items-center justify-center w-full md:mt-14">
      <span className="absolute mx-auto top-0 text-h1 py-4 flex items-center border w-fit bg-gradient-to-r blur-xl from-[#505050] via-white to-[#f2f2f2] bg-clip-text text-5xl leading-[60px] lg:leading-[100px] max-w-[80%] lg:max-w-[90%] box-content font-extrabold text-transparent text-center select-none">
        {displayText}
      </span>
      <motion.h1
        initial={{ opacity: 0 }}
