        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <article className="flex flex-col items-center justify-center mt-16">
            <p className="mt-5 text-justify md:max-w-[60%] md:text-center">
              At Ever Journal, we believe that every life is a story worth telling. Our values reflect our commitment
              to helping youdocument, rediscover, and share your journey in a meaningful way.
            </p>
          </article>
        </div>
